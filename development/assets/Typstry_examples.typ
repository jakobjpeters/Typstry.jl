...
#module("Typstry.jl", (
  ...
  1.2, 1 / 2
    ...
    "false//true + false//true*im", "Complex{<:Rational{<:Union{Bool, Unsigned}}}", [`block`, `mode`, `parenthesize`], ````typst $(0 / 1)$ ````, [$(0 / 1)$],
    "im", "Complex{<:Union{Bool, Unsigned}}", [`mode`, `parenthesize`], ````typst $i$ ````, [$i$],
