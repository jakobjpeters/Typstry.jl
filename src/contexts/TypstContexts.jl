...
- [`TypstString`](@ref Typstry.TypstStrings.TypstString)
...
default formatting data when calling [`show_typst`](@ref Typstry.show_typst).
...
| `mode` | [`Mode`](@ref Typstry.Modes.Mode) | The current Typst syntactical context where [`code`](@ref Typstry.Modes.code) follows the number sign, [`markup`](@ref Typstry.Modes.markup) is at the top-level and enclosed in square brackets, and [`math`](@ref Typstry.Modes.math) is enclosed in dollar signs. |
...
| `preamble` | [`TypstString`](@ref Typstry.TypstStrings.TypstString) | Used at the beginning of Typst source files generated by [`render`](@ref Typstry.Render.render) and some `show` methods. |
